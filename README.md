...
* 🌐 Passionate about building interactive user interfaces with **React**, **JavaScript**, and **TypeScript**.
* ☁️ **Cloud Computing Enthusiast**, eager to learn and experiment with **AWS** services (EC2, ECS, Step Functions) & cloud architectures.
* 🏆 Actively participating in **tech competitions, workshops, and coding bootcamps** to continuously upgrade my skills.
* 💻 Constantly learning new technologies and working on hands-on web projects.
